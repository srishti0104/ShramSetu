  ...
  return (next, context) => async (args) => {
    ...
    try {
      ...
      if (clientConfig.followRegionRedirects) {
        ...
        const bucketRegionHeader = (_c = (_b = err == null ? void 0 : err.$response) == null ? void 0 : _b.headers) == null ? void 0 : _c["x-amz-bucket-region"];
        if (bucketRegionHeader) {
          if (statusCode === 301 || statusCode === 400 && ((err == null ? void 0 : err.name) === "IllegalLocationConstraintException" || isHeadBucket)) {
            try {
              const actualRegion = bucketRegionHeader;
              (_d = context.logger) == null ? void 0 : _d.debug(`Redirecting from ${await clientConfig.region()} to ${actualRegion}`);
...
//# sourceMappingURL=chunk-WQDCRCQ5.js.map
